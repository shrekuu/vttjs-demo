...
Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["fromEvent"])(document.querySelector('#subtitlesLangPicker'), 'change').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["map"])(function (e) {
  ...
  return Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["zip"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["of"])(document.querySelector('#subtitlesLangPicker').value), Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_13__["ajax"])({
    url: "/static/".concat(subtitlesLang, ".vtt"),
    responseType: 'text' // 注意字段是纯文本

  })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["switchMap"])(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        subtitleLang = _ref2[0],
        res = _ref2[1];
